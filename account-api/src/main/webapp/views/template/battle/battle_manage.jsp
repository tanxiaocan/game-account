	...
	<div class="row-fluid ">
		...
		<div class="col-md-10">
			...
			<div class="panel panel-info">
				<div class="panel-heading">对战信息列表</div>
				<div class="bootstrap-admin-panel-content">

					<table class="table table-bordered" id="page_table"
						table_url="${contextPath}/battleSession/getList">
						<thead>
							<tr>
								<th id='id'>序列号</th>
								<th id='name'>对战名称</th>
								<th id='users'>对战用户</th>
								<th id='ending'>结局</th>
								<th id='createTime' data-options="comJs.formmatDate">创建时间</th>
								<th id='updateTime' data-options="comJs.formmatDate">最近更新时间</th>
								<th id='operation-battle'>操作</th>
							</tr>
						</thead>
					</table>
				</div>
