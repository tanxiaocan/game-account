...
var comJs = {
	 ...
	 * @returns {String}
	 */
	appendOpTdForGroup : function() {
		var opTd = '<td> <div class="btn-group">';
		opTd += '<button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">操作<span class="caret"></span></button>';
		opTd += '<ul class="dropdown-menu">';
		opTd += '<li><a onclick="groupQueryJs.getDetail($(this))">详情</a></li>';
		opTd += '<li><a onclick="groupQueryJs.getFinance($(this),';
		opTd += "'/trade/groupChargeView'";
		opTd += ')">充值明细</a></li>';222
		opTd += '<li><a onclick="groupQueryJs.getFinance($(this),';
		opTd += "'/trade/groupConsumeView'";
		opTd += ')">消费明细</a></li>';
//		opTd += '<li><a onclick="businessQueryJs.getDetail($(this),'// 收款明细
//		opTd += "'/trade/collectionDetailView'";
//		opTd += ')">收款明细</a></li>'// 收款明细end
//		opTd += '<li><a onclick="groupQueryJs.getConfirm($(this))">激活/禁用</a></li>';
		opTd += '</ul></div></td>';
		return opTd;
	},
	/**
